...
from process_data import ScatteringDataset  # <- your normalized dataset
...
def train(h5_file, save_model_path, epochs=100, batch_size=1024, lr=1e-4, visualize=True, sample_size=None):
    # Use the normalized ScatteringDataset
    dataset = ScatteringDataset(data_dir=os.path.dirname(h5_file), sample_size=sample_size)
